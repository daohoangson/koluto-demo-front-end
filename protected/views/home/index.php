...
<div>
	...
	<div style="margin-left: 310px">
		<?php foreach ($feature as $article): ?>
		<div>
			<h3><a href="<?php echo $article->article_source; ?>" target="_blank"><?php echo mb_substr(trim($article->article_title), 0, 60, 'utf-8'); ?>...</a></h3>
			<p><?php echo mb_substr(trim($article->article_text), 0, 300, 'utf-8'); ?>...</p>
		</div>
		<?php endforeach; ?>
	</div>
</div>
			...
			<?php if (!empty($sectionArticles)): ?>
				...
				<div>
					...
					<?php foreach ($sectionArticles as $article): ?>
						...
						<?php else: ?>
								<div>
									<h4><a href="<?php echo $article->article_source; ?>"><?php echo mb_substr(trim($article->article_title), 0, 45, 'utf-8'); ?>...</a></h4>
									<p><?php echo mb_substr(trim($article->article_text), 0, 150, 'utf-8'); ?>...</p>
								</div>
						<?php endif; ?>
						<?php $isFirst = false; ?>
					<?php endforeach; ?>
